...
<html>
<head>
    <title>Manage Leave Application Approval</title>
...
<body>
    ...
    <div class="leaveAppFormContainer">
        <div>
            ...
            <div>
                <input class="button-leaveApp" type="submit" value="Approve" formaction="approve_leave_application.php" onclick="return(getApproveConfirmation());"/>
                <input class="button-leaveApp" type="submit" value="Reject" formaction="reject_leave_application.php" onclick="return(getRejectConfirmation());"/>
			</div>
            <div>
                <input class="button-leaveApp" type="submit" value="Return to previous page" formaction="view_managed_leave_report.php"/>
			</div>
	</div>
    </form>
