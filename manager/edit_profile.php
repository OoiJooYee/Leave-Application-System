	...
	<form name="profileForm" method="post" action="../update_profile.php" onsubmit="return(validateProfile());">
		<div class="profileContainer">
			...
			<div>
				...
				<input type="password" id="password" name="password" value="<?php echo $row['password']; ?>" onkeyup="checkChangedPassword();" required/>
			</div>
            <div>
			...
			<div>
				<input class="button-profile" type="submit" name="submit" value="Save"/>
				<input class="button-profile" type="submit" name="submit" value="Cancel" onclick="document.location='view_profile.php'"/>
			</div>
			</div>
		</form>
